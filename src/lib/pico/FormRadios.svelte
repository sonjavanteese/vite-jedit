<script>
    ...
    export let value = 1;
    export let items = [{val: 1, titel: "Option 1"}];
    
</script>

<label for="op1">
    <input type="radio" bind:group={value} id="op1" name="option1" value="1">
    Op 1
</label>
<label for="op2">
    <input type="radio" bind:group={value} id="op2" name="option1" value="2">
    Op 2
</label>
<label for="op3">
    <input type="radio" bind:group={value} id="op3" name="option1" value="3">
    Op 3
</label>
